...
--同理
TUNING.VOIDCLOTH_BOOMERANG_USES 	= TUNING.VOIDCLOTH_BOOMERANG_USES 	* 2.4	* max_weapon	--暗影回旋镖
TUNING.STAFF_LUNARPLANT_USES		= TUNING.STAFF_LUNARPLANT_USES		* 4		* max_weapon	--亮茄杖  
